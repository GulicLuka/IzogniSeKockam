...
public class Over extends javax.swing.JFrame {
    ...
    public Over() {
        ...
        if (Okno1.score<0)
            Okno1.score=0;
  /*  jLabel2.setText(Zacetna_stran.ime+": "+Okno1.score+" točk");*/
    ...
    private void initComponents() {
        ...
        jButton1.setText("IGRAJ PONOVNO");
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 130, 213, 69));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 210, 91, 46));
...
/*   Zacetna_stran.ime =  JOptionPane.showInputDialog("Vnesi ime");
   if(Zacetna_stran.ime.isEmpty())
   {
         Zacetna_stran.ime =  JOptionPane.showInputDialog("Vnesi ime");
   }  
   else 
